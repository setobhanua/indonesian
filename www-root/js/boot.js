...
QuizGame.Boot.prototype = {
    ...
    preload: function () {
        this.load.spritesheet('buttonCategory_1', 'assets/LEVEL1.png', 180, 40);
        this.load.spritesheet('buttonCategory_2', 'assets/LEVEL2.png', 180, 40);
        this.load.spritesheet('buttonCategory_3', 'assets/LEVEL3.png', 180, 40);
        this.load.pack('images_questions', 'assets/images-pack.json', null, this);
        this.load.image('button', 'assets/button-ijo.png');
        this.load.image('win', 'assets/winner.jpg');
